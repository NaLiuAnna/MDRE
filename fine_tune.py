...
parser.add_argument('--epochs', type=int, default=5, help='The total number of training epochs.')
...
tokenizer = model_params['tokenizer_class'].from_pretrained(model_params['pretrained_model_name'], do_lower_case=False)
